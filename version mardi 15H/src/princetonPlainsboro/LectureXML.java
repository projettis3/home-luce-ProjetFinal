...
public class LectureXML {
    ...
    public DossierMedical getDossier() {
        ...
        String numeroTelephoneCourant = "";
        String motDePasseCourant = "";
        Long numSecuCourant = null;
                ...
                switch (event) {
                    ...
                    case XMLStreamConstants.END_ELEMENT:
                        ...
                        if (parser.getLocalName().equals("medecin")) {
                            medecinCourant = new Medecin(nomCourant, prenomCourant, specialiteCourante, numeroTelephoneCourant, motDePasseCourant);
                        }
                        if (parser.getLocalName().equals("nom")) {
                            nomCourant = donneesCourantes;
                        }
                        if (parser.getLocalName().equals("patient")) {
                            patientCourant = new Patient(nomCourant, prenomCourant, numSecuCourant, cleCourante, date, adresseCourante);
                        }
                        ...
                        if (parser.getLocalName().equals("specialite")) {
                            ...
                            if (specialiteCourante == null) {
                                throw new XMLStreamException("Impossible de trouver la specialite du medecin = " + donneesCourantes);
                            }
                        }
                        if (parser.getLocalName().equals("numeroTelephone")) {
                            numeroTelephoneCourant = donneesCourantes;
                        }
                        if (parser.getLocalName().equals("motDePasse")) {
                            motDePasseCourant = donneesCourantes;
                        }
                        if (parser.getLocalName().equals("numSecu")) {
                            numSecuCourant = Long.parseLong(donneesCourantes);
                        }
    ...
    private Specialite getSpecialite(String specialite) {
        if (specialite.equals("anesthegiologie")) {
            return Specialite.anesthegiologie;
        }
